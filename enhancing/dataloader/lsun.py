...
class LSUNBase(LSUN):
    def __init__(self, root: str, classes: Union[Tuple[str, str], str], transform: Optional[Callable] = None) -> None:
...
class LSUNTrain(LSUNBase):
    def __init__(
        self, root: str, classes: Union[Tuple[str, str], str], resolution: Union[Tuple[int, int], int] = 256
    ) -> None:
